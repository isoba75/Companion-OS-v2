/**
 * Lead Sync Script - Batch 10 (Utilities, Energy, Services)
 */
...
async function main() {
  console.log('🔄 Starting Lead Sync - Batch 10 (Utilities & Energy)...\n');
  ...
  const csvPath = '/data/workspace/memory/leads-batch-10.csv';
  ...
  console.log('\n' + '='.repeat(50));
  console.log('✅ BATCH 10 SYNC COMPLETE');
