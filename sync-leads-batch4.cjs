/**
 * Lead Sync Script - Batch 4 (BTP, Industrie, Commerce)
 */
...
async function main() {
  console.log('🔄 Starting Lead Sync - Batch 4 (BTP & Industrie)...\n');
  ...
  const csvPath = '/data/workspace/memory/leads-batch-4.csv';
  ...
  console.log('\n' + '='.repeat(50));
  console.log('✅ BATCH 4 SYNC COMPLETE');
