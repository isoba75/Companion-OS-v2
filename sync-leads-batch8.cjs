/**
 * Lead Sync Script - Batch 8 (Senegal Companies)
 */
...
async function main() {
  console.log('🔄 Starting Lead Sync - Batch 8 (Senegal)...\n');
  ...
  const csvPath = '/data/workspace/memory/leads-batch-8.csv';
  ...
  console.log('\n' + '='.repeat(50));
  console.log('✅ BATCH 8 SYNC COMPLETE');
