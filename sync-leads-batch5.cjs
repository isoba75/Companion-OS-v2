/**
 * Lead Sync Script - Batch 5 (IT & Services)
 */
...
async function main() {
  console.log('🔄 Starting Lead Sync - Batch 5 (IT & Services)...\n');
  ...
  const csvPath = '/data/workspace/memory/leads-batch-5.csv';
  ...
  console.log('\n' + '='.repeat(50));
  console.log('✅ BATCH 5 SYNC COMPLETE');
